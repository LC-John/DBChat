		...
		<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
			...
			<div class="collapse navbar-collapse" id="navbar-collapse-01">
			    <ul class="nav navbar-nav navbar-right">
                    ...
                    <li role="presentation"><a href="session_main.php" target="_self">Back</a></li>
                    &nbsp&nbsp&nbsp&nbsp
...
<?php
    ...
    if ($i_am_manager == 1)
    {
        echo '<form action="session_leave.php" method="post">'; 
        echo '<dl class="text-muted"><h4>Manager</h4></dl>';
        echo '<dl class="text-muted">User ID<dl>';
        echo '<input type="text" name="userid" value="" /><br><br>';
        echo '<input type="submit" name="submit" class="btn btn-primary" value="Change manager" />';
        echo '<br><br>';
        echo '<input type="submit" name="submit" class="btn btn-danger" value="Purge the session" />';
        echo '</form>';
    }
    else
    {
        echo '<script>alert("You are not the manager.");</script>';
