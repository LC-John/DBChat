...
<?php
	if ($_POST['submit'] == 'User')
    {
        ...
        else
        {
            ...
            $result=mysqli_query($conn, "CALL USER_SEARCH($_SESSION[userid], '$_SESSION[password]', '$_POST[name]', $tmp_granted);");
    ...
    elseif ($_POST['submit'] == 'Group')
    {
        ...
        {
            $tmp_granted = "@tmp_granted_" . (string)(date("YmdHis")) . (string)(rand(0, 63));
            $result=mysqli_query($conn, "CALL SESSION_SEARCH($_SESSION[userid], '$_SESSION[password]', '$_POST[name]', $tmp_granted);");
